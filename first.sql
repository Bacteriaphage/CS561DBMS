...
DROP TABLE MAX_DETAIL;
DROP TABLE MIN_DETAIL;
...
MIN_DETAIL.MIN_Q, MIN_DETAIL.PROD, MIN_DETAIL.MONTH, MIN_DETAIL.DAY, MIN_DETAIL.YEAR, MIN_DETAIL.STATE, (MAX_DETAIL.MAX_Q+MIN_DETAIL.MIN_Q)/2 AS AVG_Q
FROM MAX_DETAIL
